...
//       vSeeds.push_back(CDNSSeedData("seed2.callcoin.org", "seed2.callcoin.org"));
 //       vSeeds.push_back(CDNSSeedData("seed3.callcoin.org", "seed3.callcoin.org"));
 //       vSeeds.push_back(CDNSSeedData("callcoin.zapto.org", "callcoin.zapto.org"));
 //       vSeeds.push_back(CDNSSeedData("callcoin.no-ip.org", "callcoin.no-ip.org"));
//        vSeeds.push_back(CDNSSeedData("callcoin.strangled.net", "callcoin.strangled.net"));
//        vSeeds.push_back(CDNSSeedData("callcoin.ignorelist.com", "callcoin.ignorelist.com"));
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        // vSeeds.push_back(CDNSSeedData("callcoin.test", "test.callcoin.org"));
